  ...
  return (
    <div className="w-full h-[100vh] overflow-x-hidden">
      <div className="flex relative w-full">
        <div className="absolute bg-[#19E99E] w-100 h-100 rounded-full blur-[200px] -left-100 md:-left-50 -top-70 z-100"></div>
        <div className="absolute bg-[#18363F] w-100 h-100 rounded-full blur-[150px] -right-80 md:-right-10 -top-40 z-100"></div>
        <div className="absolute left-10 w-0.5 h-60 bg-gradient-to-b from-white/50  to-white/10 clip-pontuda z-100"></div>
        <div className="absolute left-10 top-30 w-0.5 h-15 bg-gradient-to-b from-[#19E99E]/10  to-[#19E99E]/100 cima z-100"></div>
        <div className="absolute right-12 top-15 w-0.5 h-15 bg-gradient-to-b from-[#3BD0FF]/100  to-[#3BD0FF]/10 baixo z-100"></div>
        <div className="absolute right-12 w-0.5 h-70 bg-gradient-to-b from-white/50  to-white/10 clip-pontuda z-100"></div>
        <div className="flex absolute w-full justify-center top-20">
          <div className="absolute flex gap-2 items-center">
            <img src={Logo} className="w-10 z-100" />
            <h1 className="text-2xl bg-gradient-to-b from-white to-gray-300/50 bg-clip-text text-transparent z-100">
              Safety
